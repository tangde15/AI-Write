...
### v1.1.0 (2024-10-XX) 🔄
- ✨ **新增作文对比功能**: 学生可以选择与历史作文对比，AI从五感训练法角度进行深度对比分析
- 📊 **五感训练法评分**: 重点评估视觉、听觉、味觉、嗅觉、触觉五感描写的运用
- 🎨 **界面美化**: 优化历史作文列表显示，支持文本省略和完美对齐
- 🔄 **对比分析报告**: 显示两篇作文的进步亮点、需要改进之处和具体训练建议
- 💾 **数据库扩展**: 新增previous_record_id和comparison_analysis字段
